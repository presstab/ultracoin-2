...
static const int nProtocol6 = 1719400; //protocol 6 fork block
...
public:
    ...
    {
        if (!fHashed) {
            //printf("GetHash: %ld %d %u %ul", CVOIDBEGIN(nVersion), sizeof(block_header), UINTBEGIN(hashCached), GetNfactor(nTime));
